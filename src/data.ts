  ...
  },
  {
    ...
    accounts: [
      ...
      },
      {
        id: 'brokerage',
        name: 'Brokerage',
        institution: 'Alder Invest · Taxable',
        balance: '$43,086.36',
        initials: 'AI',
...
export const INSTITUTIONS: Institution[] = [
  ...
  { name: 'Alder Invest', sub: '1 account · Synced 1 day ago', initials: 'AI', avatarBg: 'oklch(0.95 0.04 300)', avatarFg: 'oklch(0.42 0.09 300)', status: 'connected' },
]
